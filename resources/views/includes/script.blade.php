...
<script src="https://cdn.jsdelivr.net/npm/jquery@2.2.4/dist/jquery.min.js"></script>
    ...
    <script src="/dashboard/js/init/weather-init.js"></script>

    <script src="https://cdn.jsdelivr.net/npm/moment@2.22.2/moment.min.js"></script>
    <script src="https://cdn.jsdelivr.net/npm/fullcalendar@3.9.0/dist/fullcalendar.min.js"></script>
    <script src="/dashboard/js/init/fullcalendar-init.js"></script>

    <script src="/dashboard/js/lib/data-table/datatables.min.js"></script>
    <script src="/dashboard/js/lib/data-table/dataTables.bootstrap.min.js"></script>
    <script src="/dashboard/js/lib/data-table/dataTables.buttons.min.js"></script>
    <script src="/dashboard/js/lib/data-table/buttons.bootstrap.min.js"></script>
    ...
    <script src="/dashboard/js/init/datatables-init.js"></script>
